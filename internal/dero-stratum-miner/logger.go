...
func (c *Client) setLogger() error {
	...
	logger := newLogger(c.console.Stdout(), f, c.config.Debug, c.config.CLogLevel, c.config.FLogLevel)
...
func newLogger(console, logfile io.Writer, debug bool, clogLevel, flogLevel int8) logr.Logger {
